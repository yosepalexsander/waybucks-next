...
const API = () => (function(){
   ...
   */
  async function register<T>(data: Record<string, any>, config: AxiosRequestConfig): Promise<AxiosResponse<T>> {
   ...
   * @returns response object
   */
  async function login<T>(data: Record<string, any>, config: AxiosRequestConfig): Promise<AxiosResponse<T>> {
   ...
   * @returns response object
   */
  async function getCarts<T>(): Promise<T> {
   ...
   * @returns response object
   */
  async function getUserTransactions<T>(): Promise<T> {
   ...
   * @returns response object
   */
  async function getAllTransactions<T>(): Promise<T> {
   ...
   * @returns response object
   */
  async function postProduct<T>(data: Record<string, string>, config: AxiosRequestConfig): Promise<T> {
   ...
   * @returns response object
   */
  async function postCart<T>(data: Record<string, string>, config: AxiosRequestConfig): Promise<T> {
   ...
   * @returns response object
   */
  async function postTransaction<T>(data: Record<string, string>, config: AxiosRequestConfig): Promise<T> {
   ...
   * @returns response object
   */
  async function updateProduct<T>(id: string, data: Record<string, string>, config: AxiosRequestConfig): Promise<T> {
   ...
   * @returns response object
   */
  async function updateCart<T>(id: string, data: Record<string, string>, config: AxiosRequestConfig): Promise<T> {
   ...
   * @returns response object
   */
  async function updateTransaction<T>(id: string, data: Record<string, string>, config: AxiosRequestConfig): Promise<T> {
